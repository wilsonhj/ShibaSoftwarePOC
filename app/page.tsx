    ...
    <div className="flex flex-col">
      ...
      <section className="relative overflow-hidden py-24 sm:py-32 lg:py-40">
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <HeroAnimated>
            ...
            <AnimatedHeading className="text-4xl font-heading font-bold tracking-tight sm:text-6xl lg:text-7xl">
            ...
            <AnimatedParagraph className="mt-8 text-lg sm:text-xl leading-8 text-muted-foreground max-w-2xl mx-auto">
            ...
            <AnimatedItem className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
      ...
      <section className="py-24 sm:py-32 relative">
        ...
        <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
          <ScrollAnimatedSection className="mx-auto max-w-2xl text-center mb-16">
          ...
          <ScrollAnimatedGrid className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
            <ServiceCard
      ...
      <section className="py-24 sm:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <ScrollAnimatedGrid className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4 max-w-5xl mx-auto">
            {[
      ...
      <section className="py-24 sm:py-32 relative">
        ...
        <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <ScrollAnimatedGrid className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <FeatureCard
      ...
      <section className="py-24 sm:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <ScrollAnimatedSection className="mx-auto max-w-4xl">
            <div className="relative rounded-2xl border border-border/50 bg-card/50 backdrop-blur-sm p-8 md:p-12 overflow-hidden">
              ...
              <div className="relative text-center">
                <div className="text-6xl font-heading font-bold text-primary mb-4">&ldquo;</div>
      ...
      <section className="py-24 sm:py-32 relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
          <ScrollAnimatedSection className="mx-auto max-w-2xl text-center">
            <h2 className="text-3xl font-heading font-bold tracking-tight sm:text-4xl lg:text-5xl">
...
function FeatureCard({ icon, title, description }: {
  ...
  return (
    <AnimatedGridItem className="flex flex-col items-center text-center p-8 rounded-xl bg-card/50 border border-border/50">
